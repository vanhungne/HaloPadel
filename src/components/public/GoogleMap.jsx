      ...
      <div className="w-full px-4 md:px-8 max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-[#555555] text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            {section?.subtitle || 'HaloPadel tọa lạc tại Đà Nẵng, thuận tiện di chuyển và dễ tìm đường.'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-10">
          ...
          <div className="lg:col-span-8 relative rounded-[20px] sm:rounded-[28px] overflow-hidden border border-[#D45A2A]/20 h-[280px] sm:h-[360px] lg:h-[500px] shadow-[0_24px_70px_rgba(212,90,42,0.12)]">
            ...
            <div className="absolute top-4 left-4 md:top-6 md:left-6 bg-white/95 backdrop-blur-md px-5 py-3.5 rounded-xl shadow-lg border border-[#E8E2D2] pointer-events-none hidden sm:block">
              ...
              <p className="text-[#555555] text-[12.5px] font-medium">Đường Nguyễn Tri Phương, Đà Nẵng</p>
            </div>
          ...
          <div className="lg:col-span-4 bg-[#FFFDF6] rounded-[20px] sm:rounded-[28px] p-5 sm:p-6 md:p-8 border border-[#E8E2D2] shadow-sm flex flex-col hover:shadow-md transition-shadow duration-300">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div>
                ...
                <p className="text-[#D45A2A] text-[13px] font-medium">Sân padel hiện đại tại Đà Nẵng</p>
              </div>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6 flex-1">
              {[
                ...
                { icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z', label: 'Zalo', value: venue?.zalo || '0909123456', href: venue?.zalo ? `https://zalo.me/${venue.zalo}` : 'https://zalo.me/0909123456', target: '_blank' },
                { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', label: 'Email', value: venue?.email || 'info@halopadel.vn', href: venue?.email ? `mailto:${venue.email}` : 'mailto:info@halopadel.vn' },
                { icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', label: 'Giờ mở cửa', value: '06:00 - 22:00 hằng ngày' },
